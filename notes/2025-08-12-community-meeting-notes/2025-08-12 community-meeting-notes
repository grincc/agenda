...
trans: @wiesche > transatoshiツ: Ah gotcha, not too familiar with Umbrel. Is it just a generic OS to run on anything, or meant for like little NAS devices?
👍 wiesche
...
trans: @wiessche If there is anything I can do to make the work go faster I am willing to help or do testing for you.
...
trans: Adresses are generated by the wallet, but are transported over TOR, so using slatepacks which are just a string of code is much better
👍 bluegecko, wiesche
...
trans: I am going to be making a memes for tips site very similar to suchwow.xyz except without needing to make an account. You'll be able to post memes with a slatepack address or email/TG/etc for manual slatepacks so you can receive tips
💛 wayne, mammothine, bluegecko, cekic

cekic: Summer breeze tonight lol 💛
🙂 wiesche

trans: I figure that'll drive a bit of engagement with Grin and also be another way to obtain free Grin along with my faucet. Got the Grin node as a service playbook done
